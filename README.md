...
- Downloads entire SoundCloud playlists as MP3s to Apple Music or Spotify
...
> Full instructions available inside the app — click **"How to Use"** in bar for Apple Music or Spotify.


## Important Notes

- If songs don't appear or an Error occurs, check that:
